...
/// The Android implementation of [PytorchPlatform].
class PytorchAndroid extends PytorchPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('pytorch_android');

  /// Registers this class as the default instance of [PytorchPlatform]
  static void registerWith() {
    PytorchPlatform.instance = PytorchAndroid();
  }
